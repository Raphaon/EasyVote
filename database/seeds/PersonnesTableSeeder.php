...
class PersonnesTableSeeder extends Seeder
{
    ...
    public function run()
    {
    	App\Personne::create([
    		...
    		"numCNI"	=> "0".rand(0,9)."02".rand(0,9)."306".rand(0,9),
    		"telephone"	=> "237695843164" ,
    		"photocniRecto"	=> "cni1.jpg" ,
            "photocniVerso" => "cni1.jpg" ,
    		"photoP"	=> "p1.jpg" ,
    		"commune_id" => 2,
    		"bureau_de_vote_id" => 2,
    	...
    	App\Personne::create([
    		...
    		"numCNI"	=> "0".rand(0,9)."02".rand(0,9)."306".rand(0,9),
    		"telephone"	=> "237695843164" ,
    		"photocniRecto"	=> "cni2.jpg" ,
            "photocniVerso" => "cni2.jpg" ,
    		"photoP"	=> "p2.jpg" ,
    		"commune_id" => 3,
    		"bureau_de_vote_id" => 1,
            "date_inscription" => time(),
    	...
    	App\Personne::create([
    		...
    		"numCNI"	=> "0".rand(0,9)."02".rand(0,9)."306".rand(0,9),
    		"telephone"	=> "237695843164" ,
    		"photocniRecto"	=> "cni3.jpg" ,
            "photocniVerso" => "cni3.jpg" ,
    		"photoP"	=> "p2.jpg" ,
    		"commune_id" => 5,
    		"bureau_de_vote_id" => 4,
            "date_inscription" => time(),
    	...
    	App\Personne::create([
    		...
    		"numCNI"	=> "0".rand(0,9)."02".rand(0,9)."306".rand(0,9),
    		"telephone"	=> "237695843164" ,
    		"photocniRecto"	=> "cni4.jpg" ,
            "photocniVerso" => "cni4.jpg" ,
    		"photoP"	=> "p2.jpg" ,
    		"commune_id" => 5,
    		"bureau_de_vote_id" => 4,
            "date_inscription" => time(),
