                        ...
                        <div class="card-block card-body col-sm-12">
                            <div class="row">
                                <div class="form-group col-sm-5">
                                    <form action="{{ route('dashboard.inscriptions.rejected') }}" method="post" class="form-inline" id="orderByForm">
                                        @csrf
                                ...
                                <div class="form-group col-sm-5">
                                    <form action="{{ route('dashboard.inscriptions.rejected') }}" method="post" class="form-inline" id="filterByForm">
                                        @csrf
