            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Liste des inscriptions validées</strong>
                    </div>
                    <div class="card-body">
                        <div class="card-block card-body col-sm-12">
                            <div class="row">
                                <div class="form-group col-sm-5">
                                    <form action="{{ route('dashboard.inscriptions.valide') }}" method="post" class="form-inline" id="orderByForm">
                                        @csrf
                                ...
                                <div class="form-group col-sm-5">
                                    <form action="{{ route('dashboard.inscriptions.valide') }}" method="post" class="form-inline" id="filterByForm">
                                        @csrf
                        ...
                        <table id="" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                @foreach($inscriptions_v as $inscription)
