...
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.bureau_de_vote.update') }}" method="post">
                @csrf
                <input type="hidden" name="id" value="{{ $b_d_v->id }}">
                <div class="row form-group">
                    <div class="col-6">
                        Nom du bureau de vote <input type="text" name="nomBureau" class="form-control" required value="{{ @$b_d_v->nomBureau }}" >
                    </div>
                    <div class="col-6">
                        Commune
